        ...
        <div className="max-w-2/3 min-w-2/3 rounded-lg p-4 flex flex-col justify-center items-stretch bg-slate-200">
          ...
          <div className="mb-5 flex justify-between items-center">
            <div className="mr-3 flex justify-between items-center basis-10/12">
              <Button
                ...
                click={addNewTodo}
                size={
                  "bg-emerald-900 hover:bg-emerald-800 rounded-lg py-3 px-3 text-white text-2xl"
                }
              />
            ...
            <div className="flex justify-center items-center basis-2/12">
              <select
                className="container p-2 rounded text-start text-xl"
                value={filter}
          ...
          {todoList.length > 0 ? (
            ...
            filter === "all" ? (
              todoList.map((todo) => (
                <TodoItem
                  ...
                  changeFinishOrNot={(situation: boolean) =>
                    changeFinishOrNot(todo.id, situation)
                  }
                />
              ))
            ) : (
            ...
            <div className="flex justify-center items-center">
              <div
                className="rounded p-2 bg-black text-white text-2xl font-medium flex justify-center items-center"
                style={{ width: "200px" }}
              >
                No Todo
              </div>
          ...
          {finishedTodo.length > 0 && (
            <div className="container rounded-sm bg-slate-500 w-full flex flex-col justify-start items-center"></div>
          )}
